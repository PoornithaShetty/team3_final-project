...
function MixedMediaAndCollagePage(){
    useEffect(() =>{
        fetchItems();
    }, []);
    ...
    setItems(items);
       ...
       return(
        <div className=" px-4" id="paintings-bg">
             <h2 className="pb-2 py-2 text-bold border-bottom">Mixed Media And  Collage</h2>
             <div className="row  row-cols-1 row-cols-lg-4 align-items-stretch g-4 py-2">
             { items.map (item => (
                
                item.productCategory == "mixedmediaandncollage" &&
                             <div className="col">
                                 <div className="card">
...
export default MixedMediaAndCollagePage;
